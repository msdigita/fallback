...
(function() {
    try {
        function findBestTemplate(width, height) {
            ...
            const templates = [
                { width: 300, height: 600, url: 'https://msdigita.github.io/fallback/300x600.html' },
                { width: 300, height: 250, url: 'https://msdigita.github.io/fallback/300x250.html' },
                { width: 728, height: 90,  url: 'https://msdigita.github.io/fallback/728x90.html' },
                { width: 390, height: 390, url: 'https://msdigita.github.io/fallback/390x390.html' }
            ];
            const defaultTemplate = { url: 'https://msdigita.github.io/fallback/responsive.html' };
